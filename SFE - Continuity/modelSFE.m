function xdot = modelSFE(x, p, mask)
   ...
   -  VELOCITY(nstages_index)       ./ ( 1 - epsi.*mask(nstages_index))     .* CPRHOCP(nstages_index)       .*  (1 / L * nstages)       .* ( TEMP(nstages_index)                                    - TEMP(nstages_index-1)    ) + ...
    ...
    ( VELOCITY(1)./(1 - epsi.*mask(1)) ) .* ( ( 1./(1 - epsi.*mask(1)) ) .* (1 / L * nstages)   .* ( VELOCITY(1)               - v_0                )   +...
    ...
    ( VELOCITY(2:nstages_index-1)./(1 - epsi.*mask(2:nstages_index-1)) ) .* ( ( 1./(1 - epsi.*mask(2:nstages_index-1)) )    .* (1 / L * nstages)   .* ( VELOCITY(2:nstages_index-1)               - VELOCITY(1:nstages_index-2)                )   +...
    ...
    ( VELOCITY(nstages_index)./(1 - epsi.*mask(nstages_index)) ) .* ( ( 1./(1 - epsi.*mask(nstages_index)) )    .* (1 / L * nstages)   .* ( VELOCITY(nstages_index)               - VELOCITY(nstages_index-1)                )   +...
