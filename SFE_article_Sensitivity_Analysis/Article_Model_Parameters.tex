...
This study aims to analyse the influence of the operating conditions on the supercritical extraction process described in {\color{red}article 1}. To achieve this, The local sensitivity analysis methods is applied to obtain the sensitivity equations. The influence of mass-flow rate, pressure and the inlet temperature are considered.
