		...
		{\footnotesize
			\begin{align}
				...
				\begin{bmatrix}
					...
					{\color{blue}\phi_4} \left( {\color{blue}c_f}(t,z),{\color{blue}c_s}(t,z),{\color{blue}h}(t,z); {\color{magenta}\Theta} \right)
