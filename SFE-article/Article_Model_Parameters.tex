...
{\footnotesize
	\begin{equation} \label{EQ: Pressure_Velocity}
		\cfrac{d v}{d {\color{orange}\rho_f}} = - \cfrac{d v}{d{\color{blue}P}} \cfrac{d P}{d {\color{orange}\rho_f}} = -\cfrac{1}{\rho v} \cfrac{d{\color{blue}P}}{d{\color{orange}\rho_f}} = -\cfrac{v}{{\color{orange}\rho_f}}
	\end{equation}
}
