...
The quasi-one-dimensional compressible Navier-Stokes equations in Cartesian coordinates is given be equations \ref{EQ: CompressibleEuler_1} to \ref{EQ: CompressibleEuler_2}.
...
The discontinuity is presumed to be at rest relative and \todo[]{Fix the notation of pressure perturbation section to be coherent with governing equations}  the balance equations become		
