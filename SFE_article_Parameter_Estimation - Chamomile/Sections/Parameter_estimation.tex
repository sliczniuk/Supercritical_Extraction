...
\begin{document}
	...
	{\footnotesize
		\begin{equation} \label{EQ: Objective_function}
			\ln L = -\cfrac{n}{2}  \ln \sqrt{2 \pi \sigma^2} 
 	...
 	\begin{table}[h]
		\adjustbox{max width=\columnwidth}{%
			\begin{tabular}{ lccccccc }
				\hline 
				Parameter		&$k_m$[-] 	& $D_i^R\times10^{-13}$[$m^2/s$] 	& $D_e^M$[$m^2/s$]	& $\Upsilon$ [m$^3$/kg] & $\sigma$[-] \\  \hline
				Lower bound		&0	  		& 0 	  			& 0 				& 0 	   		& 0 \\ 
				Upper bound		&$+\infty$	& $+\infty$ 		& $+\infty$			& $+\infty$ 	& $+\infty$\\ 
				Initial guesses	&0.1-10		& $0.1-10$ 			& 0 		   		& 0.1-10		& 0.01 \\  \hline
		\end{tabular} }
