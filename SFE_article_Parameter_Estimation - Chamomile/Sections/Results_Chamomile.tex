...
\begin{document}
	...
	\begin{figure*}[!h]
		...
		\begin{subfigure}{0.3\textwidth}
			\centering
			\includegraphics[trim = 0.0cm 0.0cm 0.0cm 0.0cm,clip, width=\textwidth]{/Results_estimation/Fit_Di_Gamma_1_4.png}
		...
		\begin{subfigure}{0.3\textwidth}
			\centering
			\includegraphics[trim = 0.0cm 0.0cm 0.0cm 0.0cm,clip, width=\textwidth]{/Results_estimation/Fit_Di_Gamma_5_8.png}
		...
		\begin{subfigure}{0.3\textwidth}
			\centering
			\includegraphics[trim = 0.0cm 0.0cm 0.0cm 0.0cm,clip, width=\textwidth]{/Results_estimation/Fit_Di_Gamma_9_12.png}
	...
	\begin{figure*}[!h]
		...
		\begin{subfigure}{0.24\textwidth}
			\centering
			\includegraphics[trim = 0.0cm 0.0cm 0.0cm 0.0cm,clip, width=\textwidth]{/Results_estimation/Correlation_Di_Re.png}
		...
		\begin{subfigure}{0.24\textwidth}
			\centering
			\includegraphics[trim = 0.0cm 0.0cm 0.0cm 0.0cm,clip, width=\textwidth]{/Results_estimation/Correlation_Gamma_Re.png}
		...
		\begin{subfigure}{0.24\textwidth}
			\centering
			\includegraphics[trim = 0.0cm 0.0cm 0.0cm 0.0cm,clip, width=\textwidth]{/Results_estimation/Di_Re_F.png}
		...
		\begin{subfigure}{0.24\textwidth}
			\centering
			\includegraphics[trim = 0.0cm 0.0cm 0.0cm 0.0cm,clip, width=\textwidth]{/Results_estimation/Gamma_Re_F.png}
