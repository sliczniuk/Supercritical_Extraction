...
%	\noindent\textbf{Heat capacity of the fluid phase} \\
	...
	where the coefficients ({\color{black}REF}) of the expansion are ${\color{black}C_{P0}} = 4.728$, ${\color{black}C_{P1}} = 1.75 \times 10^{-3}$, ${\color{black}C_{P2}} = -1.34 \times 10^{-5}$, and ${\color{black}C_{P3}} = 4.10 \times 10^{-9}$. 
